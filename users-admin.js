...
function render(){
 ...
 const rows=users.filter(u=>u.isCommissionUser!==true&&String(u.userType||u.role||'').toLowerCase()!=='commission').filter(u=>!q||[u.fullName,u.mobile,u.email].join(' ').toLowerCase().includes(q));
