...
Security: firestore-portal.rules is provided as a NEW template. Before using customer accounts in production, create /admins/{ADMIN_UID} and deploy these rules intentionally. Do not paste PayU Merchant Salt/Secret in public JS or database. Use a secure backend endpoint for payment hash generation and verification.
